@section('breadcrumb')
    <x-breadcrumb>
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.table.users') }}">{{ trans('Users') }}</a></li>
    ...
    <div class="profile__card">
        <div class="profile__header">
            <div class="profile__header-cover">
                ...
                @else
                    <img src="{{ isset($existingCover) ? asset('storage/' . $existingCover) : asset('assets/img/banner.png') }}"
                ...
                <div class="profile__header-avatar">
                    ...
                    @else
                        <img src="{{ isset($existingAvatar) ? asset('storage/' . $existingAvatar) : asset('assets/img/avatar.jpg') }}"
