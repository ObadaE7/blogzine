<section class="categories__wrapper">
    <div class="categories__header">
        <img src="{{ asset('assets/img/category.jpg') }}" class="categories__header-img" alt="{{ trans('Posts banner') }}">
                ...
                <div class="categories__content-img">
                    ...
                    <div class="overlay-text">
                        <a href="{{ route('category', $category->slug) }}"
                            class="text-underline-link rest-text-link">View Posts</a>
                    </div>
                </div>

                <div class="categories__content-title">
                    <a href="{{ route('category', $category->slug) }}"
                        class="text-underline-link rest-text-link">{{ $category->name }}</a>
                    <div class="d-block">
